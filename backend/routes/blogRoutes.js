...
router.get("/post/:postId", adminAuth, getBlogPost);
router.patch("/update/:postId", adminAuth, upload.single("image"), updateBlogPost);
router.delete("/delete/:postId", adminAuth, deleteBlogPost);
router.delete("/bulk-delete", adminAuth, bulkDeleteBlogPosts);
router.patch("/toggle-status/:postId", adminAuth, toggleBlogStatus);
